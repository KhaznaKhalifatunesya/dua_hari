                ...
                <form>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text"
                                class="form-control border @error('name') is-invalid
                            @enderror"
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email"
                                class="form-control border @error('email') is-invalid
                            @enderror"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                @endif
                                <input type="password"
                                    class="form-control border @error('password') is-invalid
                                @enderror"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password"
                                    class="form-control border @error('password_confirmation') is-invalid
                                @enderror"
